...
Position steer(Position const& position, Command command)
{
    ...
    case Direction::forward:
        return {position.horizontal + command.units, position.depth + position.aim * command.units,
                position.aim};
    case Direction::up:
        return {position.horizontal, position.depth, position.aim - command.units};
    case Direction::down:
        return {position.horizontal, position.depth, position.aim + command.units};
